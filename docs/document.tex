...
\author{\IEEEauthorblockN{Marcos Sánchez Bajo}
    \IEEEauthorblockA{\textit{University Carlos III of Madrid} \\
        Madrid, Spain \\
        100405823@alumnos.uc3m.es}
    \and
    \IEEEauthorblockN{Juan Manuel Estévez Tapiador}
    \IEEEauthorblockA{\textit{University Carlos III of Madrid} \\
        Madrid, Spain \\
...
\noindent\fbox{%
    \parbox{\linewidth}{BYTEKEYWORD \textbar\space STARTINDEX:0 \textbar\space ENDINDEX:0\\ Byte 0:
        63 (as char: c) \textbar\space Comparison result: 0 }}\\%%
...
\ref{figure:ap_sch_s6}): \noindent\fbox{%
    \parbox{\linewidth}{KEYWORD \textbar\space STARTINDEX:0 \textbar\space ENDINDEX:1\\ Byte 0: 63
        (as char: c) \textbar\space Comparison result: 1\\ Byte 1: 65 (as char: e) \textbar\space
        Comparison result: 0 }}\\%%
...
\noindent\fbox{%
    \parbox{\linewidth}{KEYWORD \textbar\space STARTINDEX:0 \textbar\space ENDINDEX:3\\ Byte 0: 63
        (as char: c) \textbar\space Comparison result: 1\\ Byte 1: 65 (as char: e) \textbar\space
        Comparison result: 1\\ Byte 2: 78 (as char: x) \textbar\space Comparison result: 1\\
        Byte 3: 65 (as char: e) \textbar\space Comparison result: 1 }}\\%%
...
\noindent\fbox{%
    \parbox{\linewidth}{cexe \textless COMMAND\textgreater \textless
        newline\textgreater }}\\%%

We can check that this is the case by configuring INetSim to send the following
string to the malware: \noindent\fbox{%
    \parbox{\linewidth}{cexe c:\textbackslash windows\textbackslash
        system32\textbackslash calc.exe }}\\%%
...
\begin{thebibliography}{00}
    ...
    \bibitem{sota_apre} B. D. Sija, Y.-H. Goo, K.-S. Shim, H. Hasanova, and M.-S. Kim, “A Survey of Automatic Protocol Reverse Engineering Approaches, Methods, and Tools on the Inputs and Outputs View,” Security and Communication Networks, vol. 2018. Hindawi Limited, pp. 1–17, 2018. doi: 10.1155/2018/8370341. Available: http://dx.doi.org/10.1155/2018/8370341
    \bibitem{sota_apre2} J. Duchêne, C. Le Guernic, E. Alata, V. Nicomette, and M. Kaâniche, “State of the art of network protocol reverse engineering tools,” Journal of Computer Virology and Hacking Techniques, vol. 14, no. 1. Springer Science and Business Media LLC, pp. 53–68, Jan. 25, 2017. doi: 10.1007/s11416-016-0289-8. Available: http://dx.doi.org/10.1007/s11416-016-0289-8
    \bibitem{apre_survey} Y. Huang, H. Shu, F. Kang, and Y. Guang, “Protocol Reverse-Engineering Methods and Tools: A Survey,” Computer Communications, vol. 182. Elsevier BV, pp. 238–254, Jan. 2022. doi: 10.1016/j.comcom.2021.11.009. Available: http://dx.doi.org/10.1016/j.comcom.2021.11.009
    \bibitem{apre_survey2} J. Duchêne, C. Le Guernic, E. Alata, V. Nicomette, and M. Kaâniche, “State of the art of network protocol reverse engineering tools,” Journal of Computer Virology and Hacking Techniques, vol. 14, no. 1. Springer Science and Business Media LLC, pp. 53–68, Jan. 25, 2017. doi: 10.1007/s11416-016-0289-8. Available: http://dx.doi.org/10.1007/s11416-016-0289-8
    \bibitem{polyglot_caballero} J. Caballero, H. Yin, Z. Liang, and D. Song, “Polyglot,” Proceedings of the 14th ACM conference on Computer and communications security. ACM, Oct. 28, 2007. doi: 10.1145/1315245.1315286. Available: http://dx.doi.org/10.1145/1315245.1315286
    \bibitem{polyglot_source} “BitBlaze Binary Analysis Platform Release Information.” Available: http://bitblaze.cs.berkeley.edu/release/index.html
    \bibitem{github_dytan} Behzad-A, “GitHub - behzad-a/Dytan: Dytan Taint Analysis Framework on Linux 64-bit,” GitHub. Available: https://github.com/behzad-a/Dytan
    \bibitem{github_pre_reverx} Jasantunes, “GitHub - jasantunes/reverx: A protocol reverse engineer tool written in java.,” GitHub. Available: https://github.com/jasantunes/reverx
    \bibitem{github_pre_prisam} Tammok, “GitHub - tammok/PRISMA: Protocol Inspection and State Machine Analysis,” GitHub. Available: https://github.com/tammok/PRISMA/
    \bibitem{github_pre_pulsar} Hgascon, “GitHub - hgascon/pulsar: Protocol Learning and Stateful Fuzzing,” GitHub. Available: https://github.com/hgascon/pulsar
    \bibitem{github_pre_nemesys} Vs-Uulm, “GitHub - vs-uulm/nemesys: NEtwork MEssage Syntax analysYS (WOOT 2018) and NEtwork MEssage TYpe identification by aLignment (INFOCOM 2020),” GitHub. Available: https://github.com/vs-uulm/nemesys
    \bibitem{github_pre_netzob} Netzob, “GitHub - netzob/netzob: Netzob: Protocol Reverse Engineering, Modeling and Fuzzing,” GitHub. Available: https://github.com/netzob/netzob
    \bibitem{paper_dytan} J. Clause, W. Li, and A. Orso, “Dytan,” Proceedings of the 2007 international symposium on Software testing and analysis. ACM, Jul. 09, 2007. doi: 10.1145/1273463.1273490. Available: http://dx.doi.org/10.1145/1273463.1273490
    \bibitem{paper_libdft} V. P. Kemerlis, G. Portokalidis, K. Jee, and A. D. Keromytis, “libdft,” ACM SIGPLAN Notices, vol. 47, no. 7. Association for Computing Machinery (ACM), pp. 121–132, Mar. 03, 2012. doi: 10.1145/2365864.2151042. Available: http://dx.doi.org/10.1145/2365864.2151042
    \bibitem{github_libdft64} AngoraFuzzer, “GitHub - AngoraFuzzer/libdft64: libdft for Intel Pin 3.x and 64 bit platform. (Dynamic taint tracking, taint analysis),” GitHub. Available: https://github.com/AngoraFuzzer/libdft64
    \bibitem{github_triton} JonathanSalwan, “GitHub - JonathanSalwan/Triton: Triton is a dynamic binary analysis library. Build your own program analysis tools, automate your reverse engineering, perform software verification or just emulate code.,” GitHub. Available: https://github.com/JonathanSalwan/Triton
    \bibitem{book_practical_binary_analysis} D. Andriesse, Practical Binary Analysis: Build Your Own Linux Tools for Binary Instrumentation, Analysis, and Disassembly. No Starch Press, 2018.
    \bibitem{amd_manual_p65} AMD, “AMD64 Architecture Programmer’s Manual Volume 2: System Programming.” Available: https://www.amd.com/system/files/TechDocs/24593.pdf, Page 65
    \bibitem{intelpin_main} “Pin - A Dynamic Binary Instrumentation Tool,” Intel. Available: https://www.intel.com/content/www/us/en/developer/articles/tool/pin-a-dynamic-binary-instrumentation-tool.html
    \bibitem{intelpin_lukpaper} C.-K. Luk et al., “Pin,” ACM SIGPLAN Notices, vol. 40, no. 6. Association for Computing Machinery (ACM), pp. 190–200, Jun. 12, 2005. doi: 10.1145/1064978.1065034. Available: http://dx.doi.org/10.1145/1064978.1065034
    \bibitem{intel_xed_site} “X86 Encoder Decoder: X86 Encoder Decoder User Guide.” Available: https://intelxed.github.io/ref-manual/
    \bibitem{taintblade_github_repo} h3xduck, “GitHub - h3xduck/TaintBlade: A Protocol Reverse Engineering Framework” GitHub. Available: https://github.com/h3xduck/TaintBlade
    \bibitem{upx_page} “UPX: the Ultimate Packer for eXecutables - Homepage.” Available: https://upx.github.io/
    \bibitem{virtualbox_page} “Oracle VM VirtualBox.” Available: https://www.virtualbox.org/
    \bibitem{flarevm} Mandiant, “GitHub - mandiant/flare-vm: A collection of software installations scripts for Windows systems that allows you to easily setup and maintain a reverse engineering environment on a VM.,” GitHub. Available: https://github.com/mandiant/flare-vm
    \bibitem{remnux} “REMnux: A Linux Toolkit for Malware Analysts.” Available: https://remnux.org/
    \bibitem{netzob_clustering} “Overview of Netzob — Netzob 1.0~git documentation.” Available: https://netzob.readthedocs.io/en/latest/overview/index.html\#step-1-clustering-messages-and-partitioning-in-fields
    \bibitem{dispatcher_paper} J. Caballero, P. Poosankam, C. Kreibich, and D. Song, “Dispatcher,” Proceedings of the 16th ACM conference on Computer and communications security. ACM, Nov. 09, 2009. doi: 10.1145/1653662.1653737. Available: http://dx.doi.org/10.1145/1653662.1653737
    \bibitem{qemu} “QEMU” Available: https://www.qemu.org/
...
\begin{algorithm}[H]
    ...
    \FOR{comparison\_heuristic \textbf{in} heuristics\_vector.comparisons}
        \STATE heuristic\_colors $\gets$ comparison\_heuristic.colors
        \STATE first\_color\_in\_heuristic $\gets$ true
        
        \FOR{$ii$ \textbf{in} $0$ \textbf{to} heuristic\_colors.size() $- 1$}
            \STATE color $\gets$ heuristic\_colors[$ii$]
            
            \IF{color $==$ last\_compared\_color $+ 1$}
                \STATE last\_compared\_color $\gets$ color
            \ELSIF{not first\_color\_in\_heuristic}
                \STATE last\_compared\_color $\gets$ color
            \ELSE
                \STATE last\_compared\_color $\gets$ color
