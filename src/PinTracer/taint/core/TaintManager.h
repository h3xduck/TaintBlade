...
#define INS_CALL_RTN_TAINT_ENTER_0(rtn, dllName, funcName, enter_handler)	\
	RTN_InsertCall(rtn, IPOINT_BEFORE, AFUNPTR(enter_handler), IARG_INST_PTR, IARG_RETURN_IP, IARG_PTR, new std::string(dllName), IARG_PTR, new std::string(funcName), IARG_END);
#define INS_CALL_RTN_TAINT_ENTER_1(rtn, dllName, funcName, enter_handler)	\
	RTN_InsertCall(rtn, IPOINT_BEFORE, AFUNPTR(enter_handler), IARG_INST_PTR, IARG_RETURN_IP, IARG_PTR, new std::string(dllName), IARG_PTR, new std::string(funcName), IARG_FUNCARG_ENTRYPOINT_VALUE, 0, IARG_END);
#define INS_CALL_RTN_TAINT_ENTER_2(rtn, dllName, funcName, enter_handler)	\
	RTN_InsertCall(rtn, IPOINT_BEFORE, AFUNPTR(enter_handler), IARG_INST_PTR, IARG_RETURN_IP, IARG_PTR, new std::string(dllName), IARG_PTR, new std::string(funcName), IARG_FUNCARG_ENTRYPOINT_VALUE, 0, IARG_FUNCARG_ENTRYPOINT_VALUE, 1, IARG_END);
#define INS_CALL_RTN_TAINT_ENTER_3(rtn, dllName, funcName, enter_handler)	\
	RTN_InsertCall(rtn, IPOINT_BEFORE, AFUNPTR(enter_handler), IARG_INST_PTR, IARG_RETURN_IP, IARG_PTR, new std::string(dllName), IARG_PTR, new std::string(funcName), IARG_FUNCARG_ENTRYPOINT_VALUE, 0, IARG_FUNCARG_ENTRYPOINT_VALUE, 1, IARG_FUNCARG_ENTRYPOINT_VALUE, 2, IARG_END);
#define INS_CALL_RTN_TAINT_ENTER_4(rtn, dllName, funcName, enter_handler)	\
	RTN_InsertCall(rtn, IPOINT_BEFORE, AFUNPTR(enter_handler), IARG_INST_PTR, IARG_RETURN_IP, IARG_PTR, new std::string(dllName), IARG_PTR, new std::string(funcName), IARG_FUNCARG_ENTRYPOINT_VALUE, 0, IARG_FUNCARG_ENTRYPOINT_VALUE, 1, IARG_FUNCARG_ENTRYPOINT_VALUE, 2, IARG_FUNCARG_ENTRYPOINT_VALUE, 3, IARG_END);
#define INS_CALL_RTN_TAINT_ENTER_5(rtn, dllName, funcName, enter_handler)	\
	RTN_InsertCall(rtn, IPOINT_BEFORE, AFUNPTR(enter_handler), IARG_INST_PTR, IARG_RETURN_IP, IARG_PTR, new std::string(dllName), IARG_PTR, new std::string(funcName), IARG_FUNCARG_ENTRYPOINT_VALUE, 0, IARG_FUNCARG_ENTRYPOINT_VALUE, 1, IARG_FUNCARG_ENTRYPOINT_VALUE, 2, IARG_FUNCARG_ENTRYPOINT_VALUE, 3, IARG_FUNCARG_ENTRYPOINT_VALUE, 4, IARG_END);
#define INS_CALL_RTN_TAINT_ENTER_6(rtn, dllName, funcName, enter_handler)	\
	RTN_InsertCall(rtn, IPOINT_BEFORE, AFUNPTR(enter_handler), IARG_INST_PTR, IARG_RETURN_IP, IARG_PTR, new std::string(dllName), IARG_PTR, new std::string(funcName), IARG_FUNCARG_ENTRYPOINT_VALUE, 0, IARG_FUNCARG_ENTRYPOINT_VALUE, 1, IARG_FUNCARG_ENTRYPOINT_VALUE, 2, IARG_FUNCARG_ENTRYPOINT_VALUE, 3, IARG_FUNCARG_ENTRYPOINT_VALUE, 4, IARG_FUNCARG_ENTRYPOINT_VALUE, 5, IARG_END);
