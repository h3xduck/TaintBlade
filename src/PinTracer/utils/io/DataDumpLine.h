	...
	namespace IO
	{
		namespace DataDumpLine
		{
			...
			typedef enum memory_color_event
			{
				...
				TAINTGEN,	//Explicitely tainted a memory location because of a rule specified at a taint routine
				CHANGEGEN,  //Explicitely changed the taint of a memory location because of a rule specified at a taint routine
			};
