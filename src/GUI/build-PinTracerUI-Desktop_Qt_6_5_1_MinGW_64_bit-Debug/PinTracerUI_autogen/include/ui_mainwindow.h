...
public:
    ...
    QAction *actionExit;
    QAction *actionOpen;
    QAction *actionSelect_output_directory;
    QAction *actionRun;
    QAction *actionStop;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionSelect_output_directory = new QAction(MainWindow);
        actionSelect_output_directory->setObjectName("actionSelect_output_directory");
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/res/icons/icons8-log-26.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSelect_output_directory->setIcon(icon2);
        ...
        menuFile->addAction(actionSelect_output_directory);
        ...
        toolBar->addAction(actionSelect_output_directory);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionSelect_output_directory->setText(QCoreApplication::translate("MainWindow", "Select output dir", nullptr));
