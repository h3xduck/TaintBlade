...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/res/res/icons8-opened-folder-26.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionOpen->setIcon(icon1);
        actionSelect_configuration = new QAction(MainWindow);
        actionSelect_configuration->setObjectName("actionSelect_configuration");
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/res/res/icons8-log-26.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSelect_configuration->setIcon(icon2);
        actionRun = new QAction(MainWindow);
        actionRun->setObjectName("actionRun");
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/res/res/icons8-start-26.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionRun->setIcon(icon3);
        actionStop = new QAction(MainWindow);
        actionStop->setObjectName("actionStop");
        actionStop->setEnabled(false);
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/res/res/icons8-stop-26.png"), QSize(), QIcon::Normal, QIcon::Off);
